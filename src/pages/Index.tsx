    ...
    <div className="min-h-screen bg-gradient-to-br from-coral-50 to-mint-50">
      ...
      <div className="container mx-auto px-4 pt-20 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-6xl font-bold text-navy-900 mb-6 font-playfair leading-tight">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-navy-900 mb-4 font-playfair">
                  Умный гардероб
                </h3>
          ...
          <div className="max-w-md mx-auto">
            <Card className="border-0 shadow-2xl">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-center text-navy-900 mb-6 font-playfair">
                  Создать аккаунт
                </h3>
